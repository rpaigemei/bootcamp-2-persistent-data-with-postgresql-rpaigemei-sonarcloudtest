...
import type { AddConstraintOptions, ColumnsDescription, ConstraintDescription, CreateDatabaseOptions, CreateSchemaOptions, DatabaseDescription, DeferConstraintsOptions, DescribeTableOptions, FetchDatabaseVersionOptions, ListDatabasesOptions, QiDropAllTablesOptions, QiDropTableOptions, QiListSchemasOptions, QiListTablesOptions, RemoveColumnOptions, RemoveConstraintOptions, ShowConstraintsOptions } from './query-interface.types';
...
export declare class AbstractQueryInterfaceTypeScript {
     ...
     */
    constructor(sequelize: Sequelize, queryGenerator: AbstractQueryGenerator, internalQueryInterface?: AbstractQueryInterfaceInternal);
    /**
     * Create a database
     *
     * @param database
