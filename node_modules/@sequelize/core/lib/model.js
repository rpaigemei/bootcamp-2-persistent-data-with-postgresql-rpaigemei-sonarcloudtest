...
${associationOwner._getAssociationDebugList()}`);
  ...
  static async destroy(options) {
    ...
    if (!options.truncate && !(0, import_isPlainObject.default)(options.where) && !Array.isArray(options.where) && !(options.where instanceof import_base_sql_expression.BaseSqlExpression)) {
